...
Get the vectors of body_mass_g for female and male chinstrap penguins separately 
...
Are male chinstrap penquins statistically larger (body mass) than female chinstrap penguins?
...
### Make a beeswarm plot with the mean +- 1sd
